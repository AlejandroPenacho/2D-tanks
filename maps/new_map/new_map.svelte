...
<div style="transform: translate({game.scenery.vibration.displacement[0]}px, {game.scenery.vibration.displacement[1]}px)">
   <svg
      width="{Math.floor(300*ratio)}"
      height="{Math.floor(200*ratio)}"
      viewBox= "0 0 300 200"
      version="1.1"
      id="svg5"
